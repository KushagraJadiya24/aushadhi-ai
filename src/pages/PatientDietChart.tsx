      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-foreground">Diet Chart</h1>
              <p className="text-muted-foreground">Personalized Ayurvedic diet plan for {patient.name}</p>
            </div>
          </div>
          <div className="flex gap-2">
            ...
            >
              ...
              {isEditing ? "Save Changes" : "Edit Chart"}
            </Button>
        ...
        <Card>
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
              ...
              Diet Chart for {dietChart.patientName}
            </CardTitle>
            <CardDescription className="flex items-center gap-4">
              <Badge variant="outline">Constitution: {dietChart.dosha}</Badge>
              <Badge variant="outline">Season: {dietChart.season}</Badge>
              <Badge variant="outline">Generated: {dietChart.generatedDate}</Badge>
              {isEditing && (
              ...
              <CardContent>
                <div className="grid gap-4">
                  {meal.items.map((item, itemIndex) => (
                    <div key={itemIndex} className={`flex items-center justify-between p-4 border rounded-lg ${isEditing ? 'bg-muted/50 border-dashed' : 'bg-card'}`}>
        ...
        <div className="grid md:grid-cols-2 gap-6">
            ...
            <CardContent className="space-y-4">
              <div className="space-y-3">
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-sm">{dietChart.nutritionalBreakdown.calories} kcal</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-sm font-medium">Protein</span>
                  <span className="text-sm">{dietChart.nutritionalBreakdown.protein}g</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-sm font-medium">Carbohydrates</span>
                  <span className="text-sm">{dietChart.nutritionalBreakdown.carbs}g</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-sm font-medium">Fat</span>
                  <span className="text-sm">{dietChart.nutritionalBreakdown.fat}g</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-sm font-medium">Fiber</span>
                  <span className="text-sm">{dietChart.nutritionalBreakdown.fiber}g</span>
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              {dietChart.ayurvedicPrinciples.map((principle, index) => (
